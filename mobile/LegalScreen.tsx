...
const UPDATED_AT = '22 أغسطس 2026';
...
const privacySections: Section[] = [
  ...
  },
  {
    ...
    bullets: [
      'بيانات الحساب: الاسم واسم المستخدم، ورقم الجوال للحسابات التي أُنشئت سابقًا، ورموز الجلسة اللازمة لتسجيل الدخول. الرقم السري لا يُحفظ كنص مقروء؛ بل تتم حمايته بصيغة تجزئة آمنة على الخادم.',
  ...
  },
  {
    ...
    bullets: [
      'إنشاء الحساب وتسجيل الدخول وإدارة الجلسة من داخل التطبيق.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'لا يتطلب إنشاء الحساب أو تسجيل الدخول تثبيت تطبيق تواصل خارجي، ولا نشارك بيانات الدخول مع خدمات تواصل اجتماعي.',
  ...
  {
    title: '6. الحماية',
    body: 'نستخدم اتصال HTTPS، ورموز جلسات وصول، وتجزئة للرقم السري، وضوابط وصول على الخادم. ومع ذلك لا توجد وسيلة نقل أو تخزين إلكتروني يمكن ضمان أمانها بنسبة 100%.',
  },
  {
