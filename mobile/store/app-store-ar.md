# بيانات App Store — مستعمل مجاني

## البيانات الأساسية
- اسم التطبيق: مستعمل مجاني
- العنوان الفرعي المقترح: سوق المستعمل والإعلانات المجانية
...
## الوصف المقترح
مستعمل مجاني هو سوق للإعلانات المبوبة يسهّل عرض السلع المستعملة والجديدة مجانًا والتواصل بين البائع والمشتري.
...
للبائع إمكانية إنشاء إعلان وإضافة عدة صور وفيديو ووصف حالة السلعة وتحديد موقع الإعلان واختيار إظهار رقم الجوال للمشترين. يوفر التطبيق أدوات للإبلاغ عن المحتوى أو المستخدمين وحظر المستخدمين وإدارة الحساب وحذفه نهائيًا.

لا يفرض التطبيق رسومًا على نشر الإعلان، ولا ينفذ عمليات دفع أو تحويل أموال بين المستخدمين.

## الكلمات المفتاحية المقترحة
مستعمل,بيع,شراء,إعلانات,سوق,مجاني,سيارات,جوالات,أثاث,إلكترونيات
...
- التسجيل يتم برقم الجوال مع التحقق عبر WhatsApp OTP، ثم يمكن تسجيل الدخول بالرقم السري.
...
- Reviewer demo account (رقم جوال + PIN) لا يحتاج OTP أثناء المراجعة
